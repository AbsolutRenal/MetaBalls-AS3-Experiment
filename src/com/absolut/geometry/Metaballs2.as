...
package com.absolut.geometry{
	...
	public class Metaballs2 extends Sprite{
...
//					graphics.endFill();
				...
				if(Config.DRAW_CURVE){
					...
					graphics.curveTo(circlesIntersect[0].x, circlesIntersect[0].y, G3.x, G3.y);
					graphics.lineTo(G4.x, G4.y);
					graphics.curveTo(circlesIntersect[1].x, circlesIntersect[1].y, G2.x, G2.y);
